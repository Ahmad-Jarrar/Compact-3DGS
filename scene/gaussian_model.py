...
class GaussianModel:
    ...
    def __init__(self, model):
        ...
        self.use_trad_shs = model.use_trad_shs
        self.post_training_mlp = model.post_training_mlp

        self.active_sh_degree = 0
        self.max_sh_degree = model.sh_degree if self.use_trad_shs else 0
    ...
    def save_ply(self, path):
        ...
        # For traditional SH training features are concatenated
        if self.use_trad_shs:
